...
if __name__ == '__main__':
    ...
    fig1, ax1 = go.tof.visual.tof_projection_xy(occu)
    fig2, ax2 = go.tof.visual.unroll_cbe_sides(paddle_occupancy=occu)
    fig3, ax3 = go.tof.visual.unroll_cor(paddle_occupancy=occu)
