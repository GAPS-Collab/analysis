...
parser = argparse.ArgumentParser(prog = 'num events timeout', description = 'produces num events timed out over time as .txt file')
    ...
    for pack in reader:
        if pack.packet_type == go.io.TofPacketType.EVTBLDRHeartbeat:
            ...
            try: 
                ...
                analysis_vals['te_evt'].append(percent_te)
